...
const UserRegistration = () => {
	...
	const handleRegister = (e) => {
		...
		axios
			.post('http://localhost:8080/api/v1/registration/signup', {
				email,
				password,
				contactNumber,
				city,
								...
								>
									<div className='flex flex-wrap'>
										...
										<div className='flex mb-3 mx-auto p-3 mx-2 bg-gray-50 rounded'>
											<label className='text-gray-400  mx-6' htmlFor='bday'>
												Enter your birthday:
											</label>
											<input
												className='mx-6'
									...
									<div className='px-3 text-center'>
										...
										<p className='mt-16 text-xs text-gray-400'>
											<Link
												to={'/privacy-policy'}
												className='underline hover:text-gray-500 hover:underline text-gray-800'
											>
												Privacy Policy{' '}
											</Link>
											and
