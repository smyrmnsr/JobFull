  ...
  render() {
    return (
      ...
      >
          ...
          <div>
            {this.props.user.skills == null
              ...
              : this.props.user.skills
                  .split(",")
                  .map((skill) => (
                    <div className="inline-block px-1 mt-3 mx-1 bg-gray-dark text-sm " key={skill}>
                      {skill}
                    </div>
                  ))}
          </div>
        ...
        <section className="flex flex-col font-sans  w-full mb-5 px-5">
          <div className="text-md text-gray-dark border-b border-gray-dark tracking-widest">KNOWN LANGUAGES</div>
          <div>
            {this.props.user.languages == null
              ...
              : this.props.user.languages
                  .split(",")
                  .map((language) => (
                    <div className="inline-block px-1 mt-3 mx-1 bg-gray-dark text-sm " key={language}>
                      {language}
                    </div>
                  ))}
          </div>
